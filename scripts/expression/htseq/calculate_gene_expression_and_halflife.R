...
ggsave("K562_2014NG_total_matched_PROseq_TUs_PR.png", path = exp_fig_dir, width = 7, height = 5)
...
# corrected using published data
NGENCODE_exp_crt1 %>% cor()

make_scatter(NGENCODE_exp_crt1, "TPM_PROseq", "TPM_RNAseq", "(PRO-seq TPM)", "(RNA-seq TPM)", 0.59, 1712)
ggsave(file.path(exp_fig_dir, "K562_2014NG_PROseq_vs_RNAseq.png"), width = 5, height = 5)

make_scatter(NGENCODE_exp_crt1, "TPM_PROseq_crt1", "TPM_RNAseq", "(PRO-seq TPM corrected by ER)", "(RNA-seq TPM)", 0.46, 1712)
ggsave(file.path(exp_fig_dir, "K562_2014NG_PROseq_with_ER_correction_vs_RNAseq.png"), width = 5, height = 5)
